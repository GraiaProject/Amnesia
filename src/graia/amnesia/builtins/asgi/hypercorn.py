...
class HypercornOptions(TypedDict, total=False):
    ...
    accesslog: Union[logging.Logger, str, None]
    """default: None"""
    ...
    logconfig: Optional[str]
    """default: None"""
    logconfig_dict: Optional[dict]
    """default: None"""
    loglevel: str
    """default: 'INFO'"""
    ...
    user: Optional[int]
    """default: None"""
    verify_flags: Optional[VerifyFlags]
    """default: None"""
